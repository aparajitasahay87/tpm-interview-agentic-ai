  ...
  return {
    ...
    judge: {
      ...
      dimensions: {
        ...
        example_grounding: dimAvg('example_grounding')
      }
    },
...
async function saveRunResult(key, runNumber, runResult, categoryId) {
  ...
  try {
    ...
    `, [
      ...
      runResult.judge?.example_grounding ?? null,   // judge_grounding
